  ...
  <footer style={{ background: '#0a1628', padding: '56px 40px 32px' }}>
    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 40, marginBottom: 48 }}>
        <div>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.75, marginTop: 16, color: 'rgba(255,255,255,0.6)', maxWidth: 300 }}>
            Credence Edge is a private, project-based learning and verification platform where African students gain experience, earn rated badges, and pay for credible proof of their skills.
          </p>
          <p style={{ fontSize: 13, marginTop: 16, color: 'rgba(255,255,255,0.4)' }}>🇬🇭 Made in Ghana</p>
        </div>
        {[
          { title: 'Platform', links: [{ to: '/projects', label: 'Projects' }, { to: '/courses', label: 'Courses' }, { to: '/leaderboard', label: 'Leaderboard' }, { to: '/pricing', label: 'Pricing' }] },
          { title: 'Company',  links: [{ to: '/about', label: 'About Credence Edge' }, { to: '/contact', label: 'Contact Us' }] },
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: 24, display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10 }}>
        <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.35)' }}>© 2026 Credence Edge. All rights reserved.</p>
